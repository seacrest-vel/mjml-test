...
// });
(0, promises_1.readFile)((0, path_1.join)(__dirname, "..", "./src/components/Footer/Footer.mjml"), "utf-8").then(buffer => {
    console.log("TEMPLATE ================= :", (0, component_1.createComponentFromMJML)(buffer.toString()));
